...
"[project]/src/app/admin/plants/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function AdminPlantsPage() {
    ...
    const fetchPlantsData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        setIsLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$plantService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clearCachedPlantData"])(); // Ensure fresh data
            const fetchedPlants = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$plantService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPlantsWithCategories"])();
    ...
    const handleDeletePlant = async (plantId, plantName)=>{
        if (confirm(`האם אתה בטוח שברצונך למחוק את הצמח "${plantName}"?`)) {
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$plantService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deletePlant"])(plantId);
                toast({
                    title: "הצלחה",
...
//# sourceMappingURL=src_99dcb6e2._.js.map