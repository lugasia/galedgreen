      ...
      >
        ...
        <div
          className={cn(
            ...
            // Determine spacer width based on collapsible type and state
            "w-[--sidebar-width]", // Default for expanded sidebar or icon variant
            "group-data-[collapsible=icon]:group-data-[state=collapsed]:w-[--sidebar-width-icon]", // Icon variant collapsed
            "group-data-[collapsible=offcanvas]:group-data-[state=expanded]:w-[--sidebar-width]", // Offcanvas expanded
            "group-data-[collapsible=offcanvas]:group-data-[state=collapsed]:w-0", // Offcanvas collapsed
            
            // Adjustments for floating and inset variants concerning the spacer
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[side=left]:peer-data-[state=collapsed]:peer-data-[collapsible=offcanvas]:ml-0",
        ...
        // Inset variant adjustments (applies to both sides based on peer data)
        "peer-data-[variant=inset]:min-h-[calc(100svh-theme(spacing.4))]",
        "md:peer-data-[variant=inset]:m-2",
        // Inset + collapsed: remove margin that would be applied by expanded state
        "md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-0", 
        "md:peer-data-[variant=inset]:peer-data-[state=collapsed]:mr-0",

        // Inset + left + collapsed (icon): specific margin for left icon sidebar
        ...
        // Inset + right + collapsed (icon): specific margin for right icon sidebar
